...
export default function GroupStage({ route, navigation }) {
    ...
    const getTable = async () => {
        try {
            const res = await axios.get(`/${eventID}/${tournamentID}/grouping/tables`)
            const data = res.data
    ...
    const getFixtureGroup = async () => {
        try {
            const response = await axios.get(`/${eventID}/${tournamentID}/grouping/fixtures`)
    ...
    const getSeeding = async () => {
        try {
            const response = await axios.get(`/${eventID}/${tournamentID}/seedings`)
            const data = response.data
                    ...
                    fixtureA != null ?
                        <View >
                            ...
                            {fixtureA.map((value, i) => {
                                return <FixtureCard key={i} fixture={value} tournamentID={tournamentID} setSubmit={setSubmit} submit={submit} eventID={eventID} />
                            })}
                        </View>
